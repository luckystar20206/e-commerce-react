	...
	render() {
		return (
			<div className='app'>
				...
				<Items onShowModal={this.onShowModal} items={this.state.currentItems} onAdd={this.addToOrder}/>
				{this.state.modal && <Modal item={this.state.fullItem} onAdd={this.addToOrder} onShowModal={this.onShowModal}/>}
				<Footer />
			</div>
		);
	}
